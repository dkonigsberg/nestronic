...
uint8_t u8g2_esp32_spi_byte_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr) {
    ...
    case U8X8_MSG_BYTE_INIT: {
        ...
        bzero(&bus_config, sizeof(spi_bus_config_t));
        ...
        ESP_ERROR_CHECK(spi_bus_initialize(u8g2_esp32_hal.spi_host, &bus_config, u8g2_esp32_hal.dma_channel));

        spi_device_interface_config_t dev_config;
        bzero(&dev_config, sizeof(spi_device_interface_config_t));
        ...
        dev_config.clock_speed_hz   = 10*1000*1000; // 10MHz clock
        ...
        ESP_ERROR_CHECK(spi_bus_add_device(u8g2_esp32_hal.spi_host, &dev_config, &handle_spi));
...
uint8_t u8g2_esp32_gpio_and_delay_cb(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr) {
    ...
    case U8X8_MSG_GPIO_AND_DELAY_INIT: {
        // Initialize the GPIO and DELAY HAL functions.  If the pins for
        // DC and RESET have been specified then we define those pins
        // as GPIO outputs.
        uint64_t bitmask = 0;
        if (u8g2_esp32_hal.dc != U8G2_ESP32_HAL_UNDEFINED) {
